...
public class HomeActivity extends AppCompatActivity
    ...
    private Button btnguard,btnclient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnguard = (Button) findViewById(R.id.btnguard);
        btnguard .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), GuardMapActivity.class);
                startActivity(i);
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, GuardSettingsActivity.class);
                startActivity(intent);
                return;
            }
        });
